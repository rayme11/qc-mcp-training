# MCP Automation Training Agenda
...
- Project-specific instructions in copilot-instructions.md
...
Let me know if you want to dive deeper into any step, need code samples, or want to automate any specific MCP workflow with Python.
